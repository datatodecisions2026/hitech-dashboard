...
src/
  app/
    ...
    road-assets-coverage/page.tsx    # Calabar/Ogun/Kebbi as-built asset-layer coverage page, self-contained — own Panel/KPICard/Reveal. Overview + Timeline (gauges/bar chart/histogram/Gantt) + By Chainage (real per-segment coverage bar + fabricated itemized completion log, entity/date/chainage filters) tabs — real data mixed with a fabricated planned schedule throughout, not visually distinguished in the UI as of 2026-08-01 (3). Not the same feature as road-assets/page.tsx above — two different people independently built two different views of the road_assets table in parallel; both kept, see the 2026-08-05 changelog entry. See 2026-08-01 changelog entries
    api/
      auth/
  ...
  components/
    ...
    SideNav.tsx             # 64px icon rail (Dashboard/Progress/Machines/Personnel/Streetlights/Planning & Implementation/Road Assets/Asset Coverage), sticky below header, hidden on /login and <640px
