...
// zoom into the "41" cluster area near Ibeju seen in the wide screenshot
await page.evaluate(() => {
  const map = (window).__debugMap
  const c = map.getCenter()
  map.setZoom(15)
})
await page.waitForTimeout(3000)
await mapFrame.scrollIntoViewIfNeeded()
await page.screenshot({ path: 'scripts/hl-earthworks-zoomed.png', fullPage: false })
await browser.close()
