...
function ByChainageTab({ section, entities }: { section: string; entities: EntityRow[] }) {
  ...
  const activeFilterCount = [applied.dateFrom, applied.dateTo, applied.chFrom && applied.chTo].filter(Boolean).length
          ...
          <>
            ...
            <aside className="filter-rail" style={{
              ...
              <div style={{ padding: '16px 16px 18px', display: 'flex', flexDirection: 'column', gap: 14, overflowY: 'auto' }}>
                <div><span style={labelStyle}><IconLayers />Entity</span>
